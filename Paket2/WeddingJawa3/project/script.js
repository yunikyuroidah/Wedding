...
const weddingDate = new Date('2026-05-15T08:00:00').getTime();
...
function updateCountdown() {
    ...
    if (timeLeft > 0) {
        ...
        secondsElement.style.transform = 'scale(1.05)';
        setTimeout(() => {
        ...
        // You can add special message for wedding day
...
// Helper function to update countdown elements with animation
...
// Add celebration effect when countdown reaches zero
function addCelebrationEffect() {
    const countdownItems = document.querySelectorAll('.countdown-item');
    countdownItems.forEach((item, index) => {
        setTimeout(() => {
            item.style.animation = 'celebration 1s ease-in-out infinite';
        }, index * 200);
    });
}
